...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(
        min: 2,
        max: 50,
        minMessage: 'the pseudo must be at least {{ limit }} characters long',
        maxMessage: 'the pseudo cannot be longer than {{ limit }} characters'
    )]
     ...
     * @return string|null
     */
    public function getPlanePassword(): ?string
    {
        return $this->planePassword;
    }

    /**
     * @param string|null $planePassword
     */
    public function setPlanePassword(?string $planePassword): void
    {
